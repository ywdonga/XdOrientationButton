...
#import "XdOrientationButton.h"

@implementation XdOrientationButton
...
- (void)setEdgeInsetsStyle:(XdOrientationStyle)edgeInsetsStyle {
    ...
    switch (edgeInsetsStyle) {
        case XdOrientationStyleImageRight:{
            space = space * 0.5;
        ...
        case XdOrientationStyleImageLeft:{
            space = space * 0.5;
        ...
        case XdOrientationStyleImageBottom:{
        ...
        case XdOrientationStyleImageTop:{
            CGFloat imageHeight = CGRectGetHeight(self.imageView.frame);
            CGFloat labelHeight = CGRectGetHeight(self.titleLabel.frame);
            CGFloat buttonHeight = CGRectGetHeight(self.frame);
            CGFloat boundsCentery = (imageHeight + space + labelHeight) * 0.5;
